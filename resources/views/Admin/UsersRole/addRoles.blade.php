  ...
  <div class="container-fluid mt--5">
    <div class="row">
      <div class="col-xl-12 mb-5 mb-xl-0">
          ...
          <div class="row">
            <div class="col-md-6">
               <h5 class="heading-small text-muted mb-4">Add Roles</h5>
             </div>
             <div class="col-md-6 text-right">
               <a href="{{ url()->previous() }}" class="btn btn-sm btn-primary"><i class="ni ni-bold-left"></i> &nbsp;Back</a>
                ...
                <div class="col-lg-12">
                    ...
                    <form action="{{ url('/admin/addRoles') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                <label class="form-control-label" minlength="3" maxlength="90" for="name">Name</label>
                                <input required type="text" class="form-control txtOnly" placeholder="Name" name="name" value="">
                              </div>
                          </div>
                          <div class="col-md-12">
                                <div class="form-group">
