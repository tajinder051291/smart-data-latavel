          ...
          <td align="center" valign="top" style="padding: 0;">
            ...
            border="0" valign="top" bgcolor="#F3F4F5">
              <tbody>
                <tr>
                  <td style="padding: 0;">
                    <div class="sc-bdVaJa gilyel" display="block" style="box-sizing: border-box; position: static; border-radius: 0; -webkit-transition: all 300ms cubic-bezier(0.19, 1, 0.22, 1); transition: all 300ms cubic-bezier(0.19, 1, 0.22, 1); overflow: inherit; padding: 3rem 3rem 3rem 3rem; margin: 0rem 0rem 0rem 0rem; border-top: none; border-right: none; border-bottom: none; border-left: none; display: block;text-align: center;">
                      <img class="sc-bwzfXH evpGNr" src="https://smartebiz.softradixtechnologies.com/assets/img/pic.png"
                      alt="smartebiz" width="20" style="border: 0; width: 10rem;">
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 0;">
                      ...
                      <p>
                        Welcome to Smartebiz. Please find your login details below.
                      </p>
                      @if(isset($user['email']))
